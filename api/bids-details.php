...
if( is_db_connected() ) {
    ...
    if( isset( $_GET['id'] ) ) {
        ...
        $bids_sql = 'Select * FROM aw_bids INNER JOIN aw_users ON aw_bids.user_id = aw_users.id INNER JOIN aw_products ON aw_bids.product_id = aw_products.id ORDER BY bid_date DESC';
    }
