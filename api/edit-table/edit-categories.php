<?php
/**
 * Edits -  create, update, modify and delete categories w.r.t GET parameters
 * 
 * @package Auction Web
 */
...
if( is_db_connected() ) {
  ...
  $category_sql = "INSERT INTO aw_categories( title, description, image_path ) VALUES( '" .$title. "','" .$description. "', '" .serialize($image_path). "' )";
